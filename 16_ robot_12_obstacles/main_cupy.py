...
a_elipse_1 = 0.3*cp.ones(n_d)
b_elipse_1 = 0.3*cp.ones(n_d)
c_elipse_1 = 0.3*cp.ones(n_d)
...
x_obs_static = cp.vstack((x_centre[0]*cp.ones(num_horizon), x_centre[1]*cp.ones(num_horizon), x_centre[2]*cp.ones(num_horizon), x_centre[3]*cp.ones(num_horizon), x_centre[4]*cp.ones(num_horizon), x_centre[5]*cp.ones(num_horizon), x_centre[6]*cp.ones(num_horizon), x_centre[7]*cp.ones(num_horizon), x_centre[8]*cp.ones(num_horizon), x_centre[9]*cp.ones(num_horizon), x_centre[10]*cp.ones(num_horizon), x_centre[11]*cp.ones(num_horizon)))
y_obs_static = cp.vstack((y_centre[0]*cp.ones(num_horizon), y_centre[1]*cp.ones(num_horizon), y_centre[2]*cp.ones(num_horizon), y_centre[3]*cp.ones(num_horizon), y_centre[4]*cp.ones(num_horizon), y_centre[5]*cp.ones(num_horizon), y_centre[6]*cp.ones(num_horizon), y_centre[7]*cp.ones(num_horizon), y_centre[8]*cp.ones(num_horizon), y_centre[9]*cp.ones(num_horizon), y_centre[10]*cp.ones(num_horizon), y_centre[11]*cp.ones(num_horizon)))
z_obs_static = cp.vstack((z_centre[0]*cp.ones(num_horizon), z_centre[1]*cp.ones(num_horizon), z_centre[2]*cp.ones(num_horizon), z_centre[3]*cp.ones(num_horizon), z_centre[4]*cp.ones(num_horizon), z_centre[5]*cp.ones(num_horizon), z_centre[6]*cp.ones(num_horizon), z_centre[7]*cp.ones(num_horizon), z_centre[8]*cp.ones(num_horizon), z_centre[9]*cp.ones(num_horizon), z_centre[10]*cp.ones(num_horizon), z_centre[11]*cp.ones(num_horizon)))
