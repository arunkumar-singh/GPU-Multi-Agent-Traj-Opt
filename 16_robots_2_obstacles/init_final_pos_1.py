...
def init_final_pos(n_rob):
	...
	x_init_1 = 7*ones(n_rob//2)
	x_init_2 = -7*ones(n_rob//2)

	x_fin_1 = -7*ones(n_rob//2)
	x_fin_2 = 7*ones(n_rob//2)

	y_init_1 = linspace(-6.5,6.5,n_rob//2)
	y_init_2 = linspace(-6.5,6.5,n_rob//2)

	y_fin_1 = linspace(-6.5,6.5,n_rob//2)
	y_fin_2 = linspace(-6.5,6.5,n_rob//2)
