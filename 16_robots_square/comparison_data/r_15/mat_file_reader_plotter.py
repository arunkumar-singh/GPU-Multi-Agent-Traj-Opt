...
robot_9 = np.delete(robot_9[:,::2],50,1)
robot_10 = np.delete(robot_10[:,::2],50,1)
robot_11 = np.delete(robot_11[:,::2],50,1)
robot_12 = np.delete(robot_12[:,::2],50,1)
robot_13 = np.delete(robot_13[:,::2],50,1)
robot_14 = np.delete(robot_14[:,::2],50,1)
robot_15 = np.delete(robot_15[:,::2],50,1)
robot_16 = np.delete(robot_16[:,::2],50,1)
...
arc_mean_prop_16robot_15 = arc_mean_proposed
arc_mean_curr_16robot_15 = arc_mean_current

scipy.io.savemat('arc_mean_prop_16robot_15.mat', {'arc_mean_prop_16robot_15': arc_mean_prop_16robot_15})
scipy.io.savemat('arc_mean_curr_16robot_15.mat', {'arc_mean_curr_16robot_15': arc_mean_curr_16robot_15})
