...
a_3 = cp.asnumpy(a_3,stream=None,order='C')
b_3 = cp.asnumpy(b_3,stream=None,order='C')
c_3 = cp.asnumpy(c_3,stream=None,order='C')
...
scipy.io.savemat('a_3.mat', {'a_3': a_3})
scipy.io.savemat('b_3.mat', {'b_3': b_3})
scipy.io.savemat('c_3.mat', {'c_3': c_3})
