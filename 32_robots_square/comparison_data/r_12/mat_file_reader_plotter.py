...
#cost_smoothness_prop_32rob_12 = np.linalg.norm(np.diff(np.diff(x_smoothness)))+np.linalg.norm(np.diff(np.diff(y_smoothness)))+np.linalg.norm(np.diff(np.diff(z_smoothness)))
#cost_smoothness_curr_32rob_12 = np.linalg.norm(np.diff(np.diff(x_robot)))+np.linalg.norm(np.diff(np.diff(y_robot)))+np.linalg.norm(np.diff(np.diff(z_robot)))

scipy.io.savemat('cost_smoothness_prop_32rob_12.mat', {'cost_smoothness_prop_32rob_12': cost_smoothness_prop_32rob_12})
scipy.io.savemat('cost_smoothness_curr_32rob_12.mat', {'cost_smoothness_curr_32rob_12': cost_smoothness_curr_32rob_12})

print(cost_smoothness_prop_32rob_12)
print(cost_smoothness_curr_32rob_12)
#################################################
...
arc_mean_prop_32robot_12 = arc_mean_proposed
arc_mean_curr_32robot_12= arc_mean_current

scipy.io.savemat('arc_mean_prop_32robot_12.mat', {'arc_mean_prop_32robot_12': arc_mean_prop_32robot_12})
scipy.io.savemat('arc_mean_curr_32robot_12.mat', {'arc_mean_curr_32robot_12': arc_mean_curr_32robot_12})
