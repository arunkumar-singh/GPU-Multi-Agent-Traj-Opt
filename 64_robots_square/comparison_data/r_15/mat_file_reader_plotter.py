...
cost_smoothness_prop_64rob_15 = np.hstack((cost_smoothness_prop1, cost_smoothness_prop2 ))
cost_smoothness_curr_64rob_15 = np.hstack((cost_smoothness_curr1, cost_smoothness_curr2 ))


scipy.io.savemat('cost_smoothness_prop_64rob_15.mat', {'cost_smoothness_prop_64rob_15': cost_smoothness_prop_64rob_15})
scipy.io.savemat('cost_smoothness_curr_64rob_15.mat', {'cost_smoothness_curr_64rob_15': cost_smoothness_curr_64rob_15})

print(cost_smoothness_prop_64rob_15)
print(cost_smoothness_curr_64rob_15)
#################################################
...
arc_mean_prop_64robot_15 = arc_mean_proposed
arc_mean_curr_64robot_15 = arc_mean_current

scipy.io.savemat('arc_mean_prop_64robot_15.mat', {'arc_mean_prop_64robot_15': arc_mean_prop_64robot_15})
scipy.io.savemat('arc_mean_curr_64robot_15.mat', {'arc_mean_curr_64robot_15': arc_mean_curr_64robot_15})




cost_mean_curr_16rob_30 = np.mean(cost_smoothness_curr_64rob_15)
print (cost_mean_curr_16rob_30)
